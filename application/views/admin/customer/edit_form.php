						...
						<form action="<?php base_url(" admin/customer/edit") ?>" method="post"
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('name') ? 'is-invalid':'' ?>"
								 type="text" name="name" min="0" placeholder="Customer name" value="<?php echo $customer->name ?>" />
								<div class="invalid-feedback">
              ...
              <div class="form-group">
							...
							<!-- <div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('description') ? 'is-invalid':'' ?>"
								 name="description" placeholder="Customer description..."><?php echo $customer->description ?></textarea>
								<div class="invalid-feedback">
