			...
			<div class="container-fluid">
					...
					<div class="card-body">
						...
						<form action="<?php base_url(" admin/supplier/edit") ?>" method="post"
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('id_supplier') ? 'is-invalid':'' ?>"
								 type="text" name="id_supplier" placeholder="Supplier id" value="<?php echo $supplier->id_supplier ?>" />
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('address') ? 'is-invalid':'' ?>"
                 type="text" name="address" min="0" placeholder="Supplier address" value="<?php echo $supplier->address ?>" />
                <div class="invalid-feedback">
